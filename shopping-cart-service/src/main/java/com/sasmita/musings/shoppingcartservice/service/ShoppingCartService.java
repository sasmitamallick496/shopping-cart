...
import static com.sasmita.musings.shoppingcartservice.util.ShoppingCartConstants.SHOPPING_CART_STATUS_ACTIVE;
...
public class ShoppingCartService {
	...
	public ShoppingCartResponse getCartDetails(UUID cartId) {
		...
		cart.setStatus(SHOPPING_CART_STATUS_ACTIVE);
		return cartToResponseMapping(cart);
	}
	...
	public ShoppingCartResponse addItem(UUID cartId, String productId, int quantity) throws Exception {
		...
		return cartToResponseMapping(savedCart);
	}
	...
	public void submitCart(ShoppingCartRequest request) {
		getRepository().save(requestToCartMapping(request));
	}
	...
	private ShoppingCartResponse cartToResponseMapping(Cart cart) {
